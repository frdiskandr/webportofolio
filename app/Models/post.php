...
class post extends Model{
    ...
    // protected $fillable = ['title', 'sumber', 'deskripsi', 'link', image];
    //protected $table = 'nama tabel'; --> ini untuk memanggil nama table jika klass tabel tidak sesuai
    //           $primarykey = 'nama id'; -->  untuk mengganti primary key
}
...
//     }
// } 
// ini media penyimpanan dataa taanpa melalui database
